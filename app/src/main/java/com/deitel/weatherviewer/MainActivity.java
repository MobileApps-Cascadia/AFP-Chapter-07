...
public class MainActivity extends AppCompatActivity {
   ...
   protected void onCreate(Bundle savedInstanceState) {
      ...
      // Grab the location EditText field
      locationEditText = findViewById(R.id.locationEditText);

      // Initialize the mFusedLocationClient
      //FusedLocationProviderClient instance
      FusedLocationProviderClient mFusedLocationClient;
      mFusedLocationClient = LocationServices.getFusedLocationProviderClient(this);

      // Check users permission and ask for location services permission
      ...
      // if users location is found do something
              ...
              .addOnSuccessListener(this, new OnSuccessListener<Location>() {
                 ...
                 public void onSuccess(Location location) {
                    ...
                    if (location != null) {
                       ...
                       // Get current last location longitude and latitude coordinates
                       double latitude = lastLocation.getLatitude();
                       double longitude = lastLocation.getLongitude();

                       // Create instance of a List of addresses
                       List<Address> addressList = null;

                       // Geocoder instance used to translate lat. and long. to a String Address
                       Geocoder myGeocoder = new Geocoder(MainActivity.this);

                       // Convert the lastLocation longitude & latitude using Geocoder into a city, state
                       // display in the EditText Location box
                       try {
                          addressList =  myGeocoder.getFromLocation(latitude,longitude,1);
                          Address lastAddress = addressList.get(0);


                          String address = lastAddress.getLocality() + "," + lastAddress.getAdminArea().substring(0,2)
                                  + "," + lastAddress.getCountryCode();
